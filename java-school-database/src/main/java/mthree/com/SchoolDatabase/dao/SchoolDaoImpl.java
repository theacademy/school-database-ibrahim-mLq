...
public class SchoolDaoImpl implements SchoolDao {
    ...
    *
    * Do not change any code outside the placeholders provided.
     */
    ...
    public List<Student> allStudents() {
        ...
        String sql = "SELECT lName, fName FROM student ORDER BY student.lName";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(cs.student_id) AS numStudents FROM course c INNER JOIN course_student cs ON c.cid = cs.course_id GROUP BY c.courseCode, c.courseDesc";
